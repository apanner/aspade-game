  ...
  try {
    ...
    if (existingPlayer) {
      ...
      if (resumingPlayerId) {
        ...
        await touchPlayerLastActiveGame(playerName.trim(), code.toUpperCase(), resumingPlayerId)
    ...
    await touchPlayerLastActiveGame(playerName.trim(), code.toUpperCase(), playerId)
